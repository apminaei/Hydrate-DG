...
template <class GV, typename Params, typename U_Sh, class GFS_Sh,
          typename U, class GFS, class FEM_S>
class TimeOperator_T:
		// public Dune::PDELab::NumericalJacobianApplyVolume<TimeOperator_T<GV, Params, U_Sh, GFS_Sh,
        //               U, GFS, FEM_S>>,
		// public Dune::PDELab::NumericalJacobianVolume<TimeOperator_T<GV, Params, U_Sh, GFS_Sh,
        //               U, GFS, FEM_S>>,
...
public:
	...
	TimeOperator_T(const GV &gv_, const Params&	 property_, 
					const U_Sh &unew_Sh_, GFS_Sh gfs_Sh_, const U &unew_, GFS gfs_,
                    unsigned int intorder_ = 4)
		:gv(gv_), property( property_ ),
		unew_Sh(unew_Sh_), gfs_Sh(gfs_Sh_), unew(unew_), gfs(gfs_), intorder(intorder_)
	{
