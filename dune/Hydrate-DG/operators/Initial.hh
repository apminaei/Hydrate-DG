...
public:
                       ...
                       typename Traits::RangeType &y) const
  {
    ...
    y = icvalue.evaluate(e, xlocal)[Indices::PVId_Pw]; /* Pa */
    return;
  }
...
public:
                       ...
                       typename Traits::RangeType &y) const
  {
    ...
    y = icvalue.evaluate(e, xlocal)[Indices::PVId_Sg]; // initial gas saturation
    return;
  }
  //! get a reference to the grid view
  inline const GV &getGridView() { return gv; }
...
public:
                       ...
                       typename Traits::RangeType &y) const
  {
    ...
    y = icvalue.evaluate(e, xlocal)[Indices::PVId_XCH4]; // initial ch4 mole fraction
    return;
  }
  //! get a reference to the grid view
  inline const GV &getGridView() { return gv; }
...
public:
                       ...
                       typename Traits::RangeType &y) const
  {
    ...
    y = icvalue.evaluate(e, xlocal)[Indices::PVId_YH2O]; // initial h2o mole fraction
    return;
  }
  //! get a reference to the grid view
  inline const GV &getGridView() { return gv; }
...
public:
                       ...
                       typename Traits::RangeType &y) const
  {
    ...
    y = icvalue.evaluate(e, xlocal)[Indices::PVId_C]; // initial salt mole fraction
    return;
  }
  //! get a reference to the grid view
  inline const GV &getGridView() { return gv; }
