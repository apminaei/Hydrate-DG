namespace Dune
{
	namespace PDELab
	{
		...
		public:
			...
			Evaluation(GFS gfs_, Vector *xglobal_) : gfs(gfs_), xglobal(xglobal_), xglobal_old(xglobal_), xglobal_fp(xglobal_), dtxglobal(xglobal_), dt(1.)
			{
			}

			Evaluation(GFS gfs_, Vector *xglobal_, Vector *xglobal_old_) : gfs(gfs_), xglobal(xglobal_), xglobal_old(xglobal_old_), xglobal_fp(xglobal_), dtxglobal(xglobal_)
			{
				dt = 1e-5;
			}

			Evaluation(GFS gfs_, Vector *xglobal_, Vector *xglobal_old_, double dt_) : gfs(gfs_), xglobal(xglobal_), xglobal_old(xglobal_old_), xglobal_fp(xglobal_), dtxglobal(xglobal_), dt(dt_)
			{
			}

			Evaluation(GFS gfs_, Vector *xglobal_, Vector *xglobal_old_, Vector *xglobal_fp_, double dt_) : gfs(gfs_), xglobal(xglobal_), xglobal_old(xglobal_old_), xglobal_fp(xglobal_fp_), dtxglobal(xglobal_), dt(dt_)
			{
			}

			Evaluation(GFS gfs_, Vector *xglobal_, Vector *xglobal_old_, Vector *dtxglobal_, Vector *xglobal_fp_, double dt_) : gfs(gfs_), xglobal(xglobal_), xglobal_old(xglobal_old_), xglobal_fp(xglobal_fp_), dtxglobal(dtxglobal_), dt(dt_)
			{
			}
									...
									const typename Traits::DomainType &x, double *y)
			{
				...
				HesseMatrix[0][0] = xlocal[3];
				HesseMatrix[0][1] = xlocal[4];
				HesseMatrix[1][0] = xlocal[4];
				HesseMatrix[1][1] = xlocal[5];
				//		  for(int i=3;i<6;i++){
