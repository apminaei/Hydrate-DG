...
public:
	...
	bool isLenz1( Dune::FieldVector< double, dimension > globalPos ) const{
		if(
			(-310/Xc.x_c)  <= (140/115*(globalPos[0]-250/Xc.x_c)+globalPos[1]) && (140/115*(globalPos[0]-260/Xc.x_c)+globalPos[1]) <= (-300/Xc.x_c)
			&&
	...
	bool isLenz2( Dune::FieldVector< double, dimension > globalPos ) const{
		if(
			(-240/Xc.x_c)  >= (-(globalPos[0]-180/Xc.x_c)+globalPos[1]) && (-(globalPos[0]-190/Xc.x_c)+globalPos[1]) >= (-250/Xc.x_c)
			&&
