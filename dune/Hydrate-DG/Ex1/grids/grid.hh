...
public:
	...
	bool isLenz1( Dune::FieldVector< double, dimension > globalPos ) const{
		if(
			 	(150/150*(globalPos[0]-30/Xc.x_c)+globalPos[1]) >= (-200/Xc.x_c)
			&& 	(150/150*(globalPos[0]-40/Xc.x_c)+globalPos[1]) <= (-190/Xc.x_c) 
			&& (-15/15*(globalPos[0]-30/Xc.x_c)+globalPos[1]) <= (-200/Xc.x_c)
			 && 	(-15/15*(globalPos[0]-170/Xc.x_c)+globalPos[1]) >= (-340/Xc.x_c)  
