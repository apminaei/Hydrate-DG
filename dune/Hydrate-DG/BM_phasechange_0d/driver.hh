...
void driver(const GV &gv /* GridView*/, const PTree &ptree /* ParameterTree*/, Dune::MPIHelper &helper /* MPI-Helper*/)
{
	...
	auto const pw_basis_polynomial = Dune::PDELab::QkDGBasisPolynomial::lobatto;
	...
	/* DG type; method = 1 for NonSymm, method = 1 for Incomplete, method = -1 for Symm*/
	double method_g = 0.;
	double method_w = 0.;
	double method_T = 0.;
	double method_x = 0.;
	...
	*/
	...
	// NEWTON METHOD class; just different implementation
	//	SELECT SOLVER FOR NON-LINEAR PROBLEM
