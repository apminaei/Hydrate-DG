...
public:
	...
	constexpr static double P_c = viscosity_c * x_c * x_c / (t_c  * permeability_c);//5.e4; // Pentry Characteristic value for Pressure
	constexpr static double T_c = t_c/(density_c*specificheat_c);//1.e0; // T_ref Characteristic value for Temperature
	...
	constexpr static double X_gravity 			= P_c/(density_c*x_c);
