...
public:
	...
	constexpr static double P_c = 1.e7;//viscosity_c * x_c * x_c / (t_c  * permeability_c);//5.e4; // Pentry Characteristic value for Pressure
	constexpr static double permeability_c = 1.e-15;//viscosity_c * x_c * x_c / (t_c  * P_c);
