...
public:
	...
	constexpr static double t_c = 1.e0* 12.*3.*24.*36.; //31104 t_end Characteristic value for time
	...
	constexpr static double viscosity_c = 1.e-3;//*P_c*t_c;
	constexpr static double X_gravity = 1.;// * P_c/ x_c/density_c; // Correct
	constexpr static double density_c = 1.e3;//*P_c/ x_c/X_gravity;
	constexpr static double permeability_c = 1.e-13;//*viscosity_c * x_c *x_c / (t_c * P_c );
	constexpr static double volumetricheat_c =  1.e3;//*thermalconductivity_c * t_c/ density_c / x_c / x_c  ;;
