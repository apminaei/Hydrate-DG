	...
	*/
	...
	bool isFracture( Dune::FieldVector< double, dim > globalPos /*ndim*/ ) const{
		if( 	globalPos[0]< Xmax/X_c.x_c/2.+fracture_diameter/X_c.x_c/2.
			...
			and globalPos[1]> Zmax/X_c.x_c-fracture_depth/X_c.x_c ){
			return true;
		}else return false;
	}
	...
	bool isInitialFreeGasPocket( Dune::FieldVector< double, dim > globalPos /*ndim*/ )const{
		if( 	globalPos[0]< Xmax/X_c.x_c/2.+FGP_width/X_c.x_c/2.
			and globalPos[0]> Xmax/X_c.x_c/2.-FGP_width/X_c.x_c/2.
			and globalPos[1]< Zmax/X_c.x_c-BSR_depth/X_c.x_c-FGP_offset/X_c.x_c
			and globalPos[1]> Zmax/X_c.x_c-BSR_depth/X_c.x_c-FGP_offset/X_c.x_c-FGP_thickness/X_c.x_c){
			return true;
		}else return false;
	}
