		   ...
		   )
{
	...
	dt_min *= (1000.*364.*24.*60.*60.); /*convert to seconds*/
	dt_min *= 1./Xc_t; /*ndim*/
	double dt_max = ptree.get("adaptive_time_control.dt_max",(double)10.);
	dt_max *= (1000.*364.*24.*60.*60.); /*convert to seconds*/
	dt_max *= 1./Xc_t; /*ndim*/
